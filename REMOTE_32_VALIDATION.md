...
- `tests/remote32.test.cjs` e `tests/remote32.browser.cjs` foram derivados dos regressions v31 e passaram verificação de sintaxe.

## Limitações
- Os regressions com jsdom/Playwright não foram executados nesta sessão porque essas dependências não estavam disponíveis no ambiente do conector.
